...
import { OnePieceImporter } from "../services/import/OnePieceImporter";
...
async function main() {
  const importer = new OnePieceImporter(prisma);
  ...
  console.log(`\nGesamt: ${totalSets} One-Piece-Sets, ${totalCards} One-Piece-Karten in der Datenbank.`);
}
